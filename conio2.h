...
#define LegendPozition 1
#define TablePozitionX 80
#define MaxBoardSize 12

extern int _wscroll;		// 1 = enable scroll
			// 0 = disable scroll
enum element{zeroFixed=0, oneFixed, zero, one, nothing, cannotBeModified, isClearZero, isClearOne};
const float maxFill = 40.0;
const float minFill = 20.0;
extern int N=12;
